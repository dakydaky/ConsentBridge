        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consents_Candidates_CandidateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_Consents_ConsentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_ConsentId",
                table: "Applications",
                column: "ConsentId");

            migrationBuilder.CreateIndex(
                name: "IX_Candidates_EmailHash",
                table: "Candidates",
                column: "EmailHash",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Consents_CandidateId",
                table: "Consents",
                column: "CandidateId");
        }
